...
do
	...
	lm=`expr ${lm} + 1`
        ...
        echo ${Col_1R}"|00000000"${k}"|0000007446|GB|0000001007|"${Col6}"00"${i}"|00001|00001|0"${New[i]}"|00001|"${Date} ${Time}"|A|"${Col18[i]}"|0000000"${Column14}"|01007|00001|0000"${lm}"|" >> file25.txt
        fi
        fi
