...
do
	if ((${New[i]}==2000))
	then
        echo ${Col_1R}"|000000000"${i}"|0000007446|GB|0000001007|"${Col6}"000"${i}"|00001|00001|0"${New[i]}"|00001|"${Date} ${Time}"|A|"${Col18[i]}"|0000000"${Column14}"|01007|JSERRA5        |POS REPLEN|0834385020|GB|00002|00000|GB|07446|00002|00033|16|07/05/2023|||||07/05/2023|07/28/2023|12/31/2035|W|0|N|P|GREAT BRITAIN               GB|GB|||||||        ||||||GBP||||||" >> file25.txt
	fi 

	if ((${New[i]}==2010))
	then
	echo ${Col_1R}"|000000000"${i}"|0000007446|GB|0000001007|"${Col6}"000"${i}"|00001|00001|0"${New[i]}"|00001|"${Date} ${Time}"|A|"${Col18[i]}"|0000000"${Column14}"|01007|00001|SA426H9             |0050250810|01007|00010|0000000150||EA|00000025000|||16|00000000000|KG|| |00000067000|0000000600|" >> file25.txt
	fi
	...
	echo ${Col_1R}"|00000000"${i}"|0000007446|GB|0000001007|"${Col6}"00"${i}"|00001|00001|0"${New[i]}"|00001|"${Date} ${Time}"|A|"${Col18[i]}"|0834385020|GB||GALPHARM INTERNATIONAL        |MDM       |0210927            |02|00|ACCOUNTS DEPARTMENT           |STAGGERS LANE                 |BRAUNTON EX33 2DL             |GB|000000000 |||||" >> file25.txt
	fi
	fi
done
echo $Col_1R
