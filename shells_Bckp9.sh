...
do
	...
	if ((${New[i]}==2010))
	then
	echo ${Col_1R}"|000000000"${k}"|0000007446|GB|0000001007|"${Col6}"000"${i}"|00001|00001|0"${New[i]}"|00001|"${Date} ${Time}"|A|"${Col18[i]}"|0000000"${Column14}"|01007|00001|SA426H9             |"${arrfile2[j]}"|01007|"${arrfile4[j]}"|0000000150||EA|00000025000|||16|00000000000|KG|| |00000067000|0000000600|" >> file25.txt
	fi
